...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
    ...
    // Create reset url
    const resetUrl = `${req.protocol}://${req.get("hsot")}/api/v1/resetpassword/${resetToken}`;

    const message = `You are receiving this email beauwe you has requested the reset of a password. Please make a PUT request to: \n\n ${resetUrl}`;
